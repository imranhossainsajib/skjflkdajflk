...
function ali_css_js_file_calling(){
  ...
  wp_enqueue_script( 'comment-script', get_template_directory_uri() . '/js/jquery.themes.js', ['jquery'],time(),true);
...
function ali_css_js_file_calling_khas(){
  wp_enqueue_script('jquery');
  wp_enqueue_style('bootstrap', get_template_directory_uri().'/css/bootstrap.css', array(), '5.0.2', 'all');
}
add_action( 'admin_enqueue_scripts', 'ali_css_js_file_calling_khas' );
